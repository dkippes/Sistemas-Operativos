...
class MMU():
    ...
    def fetch(self,  logicalAddress):
        ...
        log.logger.info("Frame Base Dir: {baseDir}, Page ID: {pid}, Offset: {offset}, Physical Address={pa}".
                        format(baseDir=frameBaseDir, pid=pageId, offset=offset, pa=physicalAddress))
